...
const MagicCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        'relative z-0 h-full w-full rounded-2xl p-2',
        'bg-gray-300 dark:bg-transparent backdrop-blur-md',
    ...
    >
      ...
      {/* Background */}
      <div className="absolute inset-[1px] -z-20 rounded-2xl bg-white dark:bg-transparent backdrop-blur-md" />
    </div>
  )
}
